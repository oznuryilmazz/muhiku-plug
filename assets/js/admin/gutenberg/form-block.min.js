!(function () {
  ...
  var e = {};
  const { __: t } = wp.i18n,
    { createElement: o } = wp.element,
    { registerBlockType: r } = wp.blocks,
    { InspectorControls: l } = wp.blockEditor,
    { serverSideRender: i } = wp,
    {
      PanelBody: s,
      SelectControl: n,
      ToggleControl: a,
  ...
  for (var p in (r("muhiku-plug/form-selector", {
    ...
    attributes: {
      ...
      displayDescription: { type: "boolean" },
    },
    edit(e) {
      const {
          attributes: {
            formId: t = "",
            displayTitle: r = !1,
            displayDescription: c = !1,
          },
          setAttributes: f,
        } = e,
        p = mhk_form_block_data.forms.map((e) => ({
          value: e.ID,
          label: e.post_title,
        }));
      let m;
      ...
      return (
        p.unshift({ value: "", label: mhk_form_block_data.i18n.form_select }),
        (m = [
          o(
            l,
            { key: "mhk-gutenberg-form-selector-inspector-controls" },
            o(
              s,
              { title: mhk_form_block_data.i18n.form_settings },
              o(n, {
  ...
  e))
    this[p] = e[p];
  e.__esModule && Object.defineProperty(this, "__esModule", { value: !0 });
})();
