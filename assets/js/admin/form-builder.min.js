    ...
    m = {
      ...
      ready: function () {
        ...
        (a = p("#muhiku-plug-builder")),
          ...
          p(document).trigger("muhiku_forms_ready");
      },
      ...
      toggleEditTitle: function (e) {
        ...
        e.preventDefault(),
          ...
          t.hasClass("muhku-forms-name-editing") || t.focus(),
          t.toggleClass("muhku-forms-name-editing");
      },
        ...
        a.on(
          ...
          a.on(
            ...
            function (e) {
              ...
              e.preventDefault(),
                i ||
                  (i = wp.media.frames.muhikuforms_media_frame =
                    wp.media({
                    ...
                    (t = o.hasClass("button-add-media")
                      ...
                      t.find(".actions").show(),
                      a.trigger("muhikuFormsImageUploadAdd", [o, t]);
                  }),
                i.open();
            }
          ),
          a.on(
            ...
            function (e) {
              ...
              e.find(".attachment-thumb").remove(),
                ...
                a.trigger("muhikuFormsImageUploadRemove", [p(this), e]);
            }
          ),
          a.on(
      ...
      choiceAdd: function (e, t, i) {
        ...
        o.attr("data-key", e),
          ...
          a.trigger("muhikuFormsChoiceAdd"),
          m.choiceUpdate(t, r);
      },
      choiceDelete: function (e, t) {
        ...
        t.find("li").length < 2
          ...
          : (e.parent().remove(),
            m.choiceUpdate(t.data("field-type"), t.data("field-id")),
            a.trigger("muhikuFormsChoiceDelete"));
      },
      ...
      render_node: function (e, o, n) {
        ...
        f.append(a),
          ...
          e
            ...
            .after(s),
          p(document).trigger("muhiku-form-cloned", [n, r]),
      ...
      bindSaveOption: function () {
        p("body").on("click", ".muhiku-plug-save-button", function () {
          ...
          if (
            ...
            e.triggerHandler("muhiku_forms_process_ajax_data", [t, o]) &&
              (o = e.triggerHandler("muhiku_forms_process_ajax_data", [t, o])),
      ...
      fieldDrop: function (r) {
        ...
        r
          ...
          p.ajax({
            ...
            type: "POST",
            data: {
              action: "muhiku_forms_new_field_" + e,
