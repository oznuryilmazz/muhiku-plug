!(function (c, t) {
  c(document).ready(function () {
    ...
    c("input#everest_forms_recaptcha_type")
      .change(function () {
        var e = c("#everest_forms_recaptcha_v2_site_key").parents("tr").eq(0),
          t = c("#everest_forms_recaptcha_v2_secret_key").parents("tr").eq(0),
          s = c("#everest_forms_recaptcha_v2_invisible_site_key")
            .parents("tr")
            .eq(0),
          r = c("#everest_forms_recaptcha_v2_invisible_secret_key")
            .parents("tr")
            .eq(0),
          i = c("#everest_forms_recaptcha_v2_invisible").parents("tr").eq(0),
          a = c("#everest_forms_recaptcha_v3_site_key").parents("tr").eq(0),
          _ = c("#everest_forms_recaptcha_v3_secret_key").parents("tr").eq(0);
        (recaptcha_v3_threshold_score = c(
          "#everest_forms_recaptcha_v3_threshold_score"
        )
          .parents("tr")
          .eq(0)),
          (hcaptcha_site_key = c("#everest_forms_recaptcha_hcaptcha_site_key")
            .parents("tr")
            .eq(0)),
          ...
          c(this).is(":checked") &&
            ("v2" === c(this).val()
              ? (c("#everest_forms_recaptcha_v2_invisible").is(":checked")
      ...
      .change(),
    c("input#everest_forms_recaptcha_v2_invisible").change(function () {
      c(this).is(":checked")
        ? (c("#everest_forms_recaptcha_v2_site_key").parents("tr").eq(0).hide(),
          c("#everest_forms_recaptcha_v2_secret_key")
            .parents("tr")
            .eq(0)
            .hide(),
          c("#everest_forms_recaptcha_v2_invisible_site_key")
            .parents("tr")
            .eq(0)
            .show(),
          c("#everest_forms_recaptcha_v2_invisible_secret_key")
            .parents("tr")
            .eq(0)
            .show())
        : (c("#everest_forms_recaptcha_v2_site_key").parents("tr").eq(0).show(),
          c("#everest_forms_recaptcha_v2_secret_key")
            .parents("tr")
            .eq(0)
            .show(),
    ...
    c(".everest_forms_send_email_test").on("click", function (e) {
      e.preventDefault();
      e = {
        action: "everest_forms_send_test_email",
        email: c("#everest_forms_email_send_to").val(),
          ...
          c(".everest_forms_send_email_test")
            ...
            (t =
              !0 === e.responseJSON.success
                ? (c("#everest_forms_email_send_to").val(""),
