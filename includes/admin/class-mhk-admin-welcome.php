...
class MHK_Admin_Welcome {
	...
	public static function welcome_page() {
		...
		<div id="muhiku-plug-welcome" >
			<div class="evmuhiku-plug-welcome-header">
				<div class="evmuhiku-plug-welcome-header__logo-wrap">
					<div class="evmuhiku-plug-welcome-header__logo-icon">
					...
					<span><?php esc_html_e( 'Getting Started', 'muhiku-plug' ); ?></span>
				</div>
				<a class="muhiku-plug-welcome__skip" href="<?php echo esc_url( admin_url() ); ?>">
					<span class="dashicons dashicons-no-alt"></span>
				</a>
			</div>
			<div class="muhiku-plug-welcome-container">
				<div class="muhiku-plug-welcome-container__header">
					<h2><?php esc_html_e( 'Welcome to Muhiku Plug', 'muhiku-plug' ); ?></h2>
					<p><?php esc_html_e( 'Thank you for choosing Muhiku Plug, the most powerful and easy drag & drop WordPress form builder in the market.', 'muhiku-plug' ); ?></p>
				</div>
				<a class="muhiku-plug-welcome-video welcome-video-play">
					<img src="<?php echo esc_url( mhk()->plugin_url() . '/assets/images/welcome-video-thumb.png' ); ?>" alt="<?php esc_attr_e( 'Watch how to create your first form with Muhiku Plug', 'muhiku-plug' ); ?>" class="everest-froms-welcome-thumb">
					<button class="muhiku-plug-welcome-video__button dashicons dashicons-controls-play"></button>
				</a>
				<div class="muhiku-plug-welcome-container__action">
					<a href="<?php echo esc_url( admin_url( 'admin.php?page=mhk-builder&create-form=1' ) ); ?>" class="muhiku-plug-welcome-container__action-card">
						...
						<div class="muhiku-plug-welcome-container__action-card-content">
							<h3><?php esc_html_e( 'Create Your First Form', 'muhiku-plug' ); ?></h3>
							<p><?php esc_html_e( 'Let\'s get started with the first contact forms for your site.', 'muhiku-plug' ); ?></p>
						</div>
					</a>
					<a href="https://docs.wpeverest.com/docs/muhiku-plug/" class="muhiku-plug-welcome-container__action-card" target="blank">
						<figure class="muhiku-plug-welcome-container__action-card-img">
						...
						<div class="muhiku-plug-welcome-container__action-card-content">
							<h3><?php esc_html_e( 'Read The Full Guide', 'muhiku-plug' ); ?></h3>
							<p><?php esc_html_e( 'Read our step by step guide on how to create your first form.', 'muhiku-plug' ); ?></p>
						</div>
					</a>
				</div>
			</div>
