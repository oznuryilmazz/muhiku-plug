  ...
  Jconfirm.prototype = {
    ...
    setTitle: function (string, force) {
      ...
      if (typeof string !== "undefined")
        if (typeof string == "string") this.title = string;
          ...
          var response = string();
          if (typeof response == "string") this.title = response;
    ...
    setIcon: function (iconClass, force) {
      ...
      if (typeof iconClass !== "undefined")
        if (typeof iconClass == "string") this.icon = iconClass;
        else if (typeof iconClass === "function") {
          var response = iconClass();
          if (typeof response == "string") this.icon = response;
    ...
    _getKey: function (key) {
      ...
      if (/^[A-z0-9]+$/.test(initial)) return initial.toLowerCase();
      else return false;
    },
